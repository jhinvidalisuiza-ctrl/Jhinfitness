  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const { data: recetasData } = await supabase
        .from('recetas')
        .select('id, nombre, categoria, calorias, imagen_url')
        .limit(4)
      ...
      setStats({
        recetas: recetasCount || 0,
        programas: programasCount || 0,
        progresos: progresoCount || 0
      });
    };
    ...
    <div className="dashboard">
      <div className="container">
        ...
        <div className="dash-stats">
          ...
          <div className="stat-card">
            <div className="stat-icon" style={{ background: 'rgba(27,45,110,0.3)', color: '#60A5FA' }}>
              <Dumbbell size={24} />
            </div>
            <div>
